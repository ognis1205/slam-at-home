...
public class NativeWebRTCService: NSObject, StreamingService {
  ...
  private(set) var setupResult: AVSessionSetupResult = .success
  
  internal var webRTC: WebRTCProtocol = WebRTC(iceServers: [])
